                            ...
                            @if($row['examSlug'])
                                @switch($row['action'])
                                    @case('renew')
                                        ...
                                        @break
                                    @case('review')
                                        <a class="lumen-btn" href="/exam/{{ $row['examSlug'] }}">{{ __('Review answers') }}</a>
                                        @break
                                    @case('resume')
                                        <a class="lumen-btn" href="/exam/{{ $row['examSlug'] }}">{{ __('Resume') }}</a>
                                        @break
                                    @default
                                        <a class="lumen-btn" href="/exam/{{ $row['examSlug'] }}">{{ __('Start') }}</a>
                                @endswitch
                            @endif
                        </div>
                    </li>
